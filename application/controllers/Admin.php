...
class Admin extends CI_Controller {
    ...
    function add_user(){
        ...
        if($insert['status'] == 'success')
            $this->session->set_flashdata('success', 'User '.$postData['email'].' foi criado com sucesso!');
    ...
    function update_user_details(){
        ...
        if($update['status'] == 'success')
            $this->session->set_flashdata('success', 'Usuário ' .$postData['email'].' detalhes foram atualizados com sucesso!');
    ...
    function deactivate_user($email,$id){
        ...
        if($update['status'] == 'success')
            $this->session->set_flashdata('success', 'Usuário '.$email.' foi excluído com sucesso!');
    ...
    function reset_user_password($email,$id){
        ...
        if($update['status'] == 'success')
            $this->session->set_flashdata('success', 'Usuário '.$email.' senha foi redefinida com sucesso!');
