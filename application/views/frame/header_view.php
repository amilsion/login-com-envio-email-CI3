        ...
        <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=base_url();?>">
                    <div class="inline"> &nbsp; Nome da Organização</div>
                </a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <label class="error" id="error_changePassword">senha atual inválida</label>
                                <label class="error" id="error_changePassword2">senha deve ser pelo menos 8 caracteres (caracteres alfanuméricos ou especiais)</label>
                            </div>
                        </div>
                        &nbsp;
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <label class="error" id="error_currentPassword"> campo é necessário.</label>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <label class="error" id="error_newPassword"> campo é necessário.</label>
                                    <label class="error" id="error_newPassword2"> senha não corresponder</label>
