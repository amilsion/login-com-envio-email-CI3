	        ...
	        <div class="col-md-4 col-md-offset-4">
	            <div class="login-panel panel panel-default">
	                <div class="panel-heading">
	                    <h3 class="panel-title">Nome da organização - Por favor, faça login</h3>
	                </div>
	                <div class="panel-body">
	                	<small id="login-empty-input" class="error">e-mail ou senha não pode estar vazio<br>&nbsp;</small>
	                	<?php if($alert): ?>
	                		<small id="login-invalid-input" class="error">e-mail ou senha inválidos<br>&nbsp;</small>
	                	<?php endif; ?>
	                    ...
	                    <form role="form" method="post" onsubmit="return checkEmptyInput();" action="<?=base_url()?>authentication/login/">
	                        <fieldset>
	                            ...
	                            <div class="form-group">
	                                <small><a href="#" onclick="alert('Please contact the administrator to reset your password!')">Esqueceu a Senha?</a></small>
	                            </div>
	                            <input id="login-submit" type="submit" value="Entrae no sistema" class="btn btn-lg btn-success btn-block">
	                        </fieldset>
	                    </form>
	                </div>
	            </div>
